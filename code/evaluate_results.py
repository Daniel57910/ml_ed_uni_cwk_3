...
RESULTS_FILES_DIR = 'results_3_mar'



df_train, df_val = (
    pd.read_csv(RESULTS_FILES_DIR + "/training_results_2022_03_04-01:32.csv"),
    pd.read_csv(RESULTS_FILES_DIR + "/validation_results_2022_03_04-01:32.csv"),
)
